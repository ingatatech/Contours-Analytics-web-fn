        ...
        >
          ...
          <div className="relative bg-white rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-500 overflow-hidden border border-gray-100/50 h-[373px]">
            ...
            <div className="relative px-6 pb-6">
              ...
              {/* Contact Section */}
              <div className="bg-gradient-to-br from-gray-50 to-blue-50/50 rounded-2xl p-1 space-y-2 border border-gray-100/50 group-hover:from-blue-50 group-hover:to-indigo-50/50 transition-colors duration-300">
                {/* Email */}
                {leader.email && (
                  <div className="flex items-center text-gray-700 text-sm hover:translate-x-1 transition-transform duration-200">
                    <div className="w-9 h-9 bg-gradient-to-br from-blue-100 to-indigo-100 rounded-xl flex items-center justify-center mr-3 group-hover:from-blue-200 group-hover:to-indigo-200 transition-all duration-300 shadow-sm">
                      <Mail className="w-4 h-4 text-blue-600" />
                    </div>
                    <a
                      href={`mailto:${leader.email}`}
                      className="hover:text-blue-700 transition-colors duration-200 truncate font-medium"
                      onClick={(e) => e.stopPropagation()}
                    >
                      {leader.email}
                    </a>
